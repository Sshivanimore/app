...
<div class="card text-center" style="padding:15px;">
  <h4>Update Employee Record <a href="welcome.php?type=admin" class="btn btn-primary" style="float:right;">Home</a>
  </h4>
</div><br> 
...
<div class="container">
  <form action="update.php" method="POST" enctype="multipart/form-data">
   <div class="form-group">
    ...
    <div class="form-group">
      <label for="upload">Upload Image:</label> <span><?php echo $customer['image']; ?></span>
